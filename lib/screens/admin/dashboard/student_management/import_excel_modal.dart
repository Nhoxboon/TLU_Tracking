...
class _ImportExcelModalState extends State<ImportExcelModal> {
  ...
  Future<void> _uploadFile() async {
    ...
    try {
      print('Starting bulk import for file: ${_selectedFile!.name}');
      print('File size: ${_selectedFile!.size} bytes');

      final result = await _apiService.bulkImportStudents(_selectedFile!);

      print('Import result - Success: ${result.success}');
      print('Import result - Message: ${result.message}');
      print('Import result - Data: ${result.data}');
      ...
      print('Upload error details: ${e.toString()}');
