...
class AddAcademicYearModal extends StatefulWidget {
  const AddAcademicYearModal({super.key});

  @override
  State<AddAcademicYearModal> createState() => _AddAcademicYearModalState();
}

class _AddAcademicYearModalState extends State<AddAcademicYearModal> {
  ...
  Future<void> _handleConfirm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final result = await _apiService.createAcademicYear(academicYearData);
        ...
        if (result.success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Thêm năm học thành công'),
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Năm học field (read-only, auto-generated)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text(
