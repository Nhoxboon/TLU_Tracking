      ...
      child: Row(
        children: [
          ...
          SizedBox(
            width: 32,
            child: Checkbox(
              value: _selectedTeachers.contains(teacher.id),
              onChanged: (bool? value) {
                setState(() {
                  if (value == true) {
          ...
          // ID
          Expanded(flex: 1, child: Text(teacher.id.toString())),

          // Mã GV
          Expanded(flex: 2, child: Text(teacher.code)),

          // Tên
          Expanded(flex: 2, child: Text(teacher.name)),
          ...
          Expanded(
            flex: 2,
            child: Text(teacher.email, textAlign: TextAlign.right),
          ),

          // Ngày sinh
          Expanded(
            flex: 2,
            child: Text(teacher.birthDate, textAlign: TextAlign.right),
          ),
